 ...
 * 
 */
namespace NexaMerchant\Algolia\Providers;
...
class AlgoliaServiceProvider extends ServiceProvider
{
    ...
    public function boot(Router $router)
    {
        ...
        $this->loadTranslationsFrom(__DIR__ . '/../Resources/lang', 'Algolia');
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            dirname(__DIR__) . '/Config/Algolia.php', 'Algolia'
        );
    ...
    protected function registerCommands(): void
    {
        if ($this->app->runningInConsole()) {
            $this->commands([
                \NexaMerchant\Algolia\Console\Commands\Install::class,
                \NexaMerchant\Algolia\Console\Commands\UnInstall::class,
            ]);
        }
    }
}
